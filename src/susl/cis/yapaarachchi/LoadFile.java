...
public class LoadFile extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		 ...
		 Bundle extras = getIntent().getExtras();
		        ...
		        {
		        	topic.setText(String.valueOf("Select PDF from the list to Play"));
			...
			Button home = (Button)findViewById(R.id.home);
			 home.setOnClickListener(new OnClickListener() {			
					...
					public void onClick(View v) {
						...
						Intent i=new Intent(LoadFile.this, Start.class);
					    startActivity(i);
					}
				});
	...
	protected void onListItemClick(View v, int pos, long id) {
		    ...
		    Intent i=new Intent(LoadFile.this, PlayPdf.class);
    ...
    public boolean onContextItemSelected(MenuItem item) {
    	...
    	final AdapterContextMenuInfo info = (AdapterContextMenuInfo) item.getMenuInfo();
    	  ...
    	  case R.id.rename:
    		...
    		Intent i=new Intent(LoadFile.this, RenamePdf.class);
    		  ...
    		  builder.setMessage("Are you sure want to delete?")
    		         ...
    		         .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
    		             public void onClick(DialogInterface dialog, int id) {
    		            	 ...
    		            	 Intent i=new Intent(LoadFile.this, LoadFile.class);
							   startActivity(i);
    		            	 Toast.makeText(LoadFile.this,"Deleted the PDF successfully from the list." ,Toast.LENGTH_LONG).show();
    	  ...
    	  case R.id.speech:
    		  ...
    		  Intent in=new Intent(LoadFile.this, PlayPdf.class);
					...
					// File picked
						...
						try
						{
							...
							else
							{
								...
								Toast.makeText(LoadFile.this,"Error occured. You should select PDF file. Try again." ,Toast.LENGTH_LONG).show();
							}
						}
						catch(Exception e)
						{
							Toast.makeText(LoadFile.this,"Error occured when selecting the PDF. Please select a PDF again"+e ,Toast.LENGTH_LONG).show();
						}

...
public class LoadFileShowPdf extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		 ...
		 if(extras !=null)
	        ...
	        {
	        	topic.setText(String.valueOf("Select one from the list to view PDF"));
			...
			home=(Button)findViewById(R.id.home);
			 home.setOnClickListener(new OnClickListener() {			
					...
					public void onClick(View v) {
						...
						Intent i=new Intent(LoadFileShowPdf.this, Start.class);
					    startActivity(i);
					}
				});
	...
	protected void onListItemClick(View v, int pos, long id) {
		...
		Cursor cursor = dbHelper.fetchTodo(id);
    ...
    public boolean onContextItemSelected(MenuItem item) {
    	...
    	final AdapterContextMenuInfo info = (AdapterContextMenuInfo) item.getMenuInfo();
    	  ...
    	  case R.id.rename:
    		...
    		Intent i=new Intent(LoadFileShowPdf.this, RenamePdf.class);
    		  ...
    		  builder.setMessage("Are you sure want to delete?")
    		         ...
    		         .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
    		             public void onClick(DialogInterface dialog, int id) {
    		            	 ...
    		            	 Intent i=new Intent(LoadFileShowPdf.this, LoadFileShowPdf.class);
							   startActivity(i);
    		            	 Toast.makeText(LoadFileShowPdf.this,"Deleted the PDF successfully from the list." ,Toast.LENGTH_LONG).show();
...
case R.id.show:
    		  ...
    		  String path = cursor.getString(cursor.getColumnIndexOrThrow(TodoDbAdapter.KEY_PATH));
    		  	...
    		  	Intent intent = new Intent(LoadFileShowPdf.this, ShowPdf.class);
 		     	intent.putExtra(PdfViewerActivity.EXTRA_PDFFILENAME, path);
 		     	startActivity(intent);
    	  ...
    	  case R.id.speech:
    		  ...
    		  Intent in=new Intent(LoadFileShowPdf.this, PlayPdf.class);
						...
						try
						{
							...
							if(pdf.equalsIgnoreCase("pdf"))
							{
								...
								long id=dbHelper.maxId();
								  ...
								  Intent i=new Intent(LoadFileShowPdf.this, ShowPdf.class);
							...
							else
							{
								...
								Toast.makeText(LoadFileShowPdf.this,"Error occured. You should select PDF file. Try again." ,Toast.LENGTH_LONG).show();
							}
						}
						catch(Exception e)
						{
							Toast.makeText(LoadFileShowPdf.this,"Error occured when selecting the PDF. Please select a PDF again"+e ,Toast.LENGTH_LONG).show();
						}
